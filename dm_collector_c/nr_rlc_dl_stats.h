...
const Fmt NrRlcDlStats_NumFCLevel1IncSegDrop [] = {
...
const Fmt NrRlcDlStats_RBStats_v3 [] = {
    {UINT, "RB Config Index",                1},
    {UINT, "RB Mode",                        1},
    {UINT, "Num RLC Meta",                   4},
    {UINT, "Num Data PDU",                   4},
    {UINT, "Num Stats Rxed",                 4},
...
static int _decode_nr_rlc_dl_status_payload(const char *b,
    ...
    int start = offset;
    int pkt_ver = _search_result_int(result, "Major Version");
   ...
   case 4:
   {
       ...
       offset += _decode_by_fmt(NrRlcDlStats_NumFCLevel1IncSegDrop,
           ARRAY_SIZE(NrRlcDlStats_NumFCLevel1IncSegDrop, Fmt),
       ...
       offset += _decode_by_fmt(NrRlcDlStats_Others,
           ARRAY_SIZE(NrRlcDlStats_Others, Fmt),
           b, offset, length, result);
    ...
    case 3:
    {
       offset += _decode_by_fmt(NrRlcDlStats_v3,
           ARRAY_SIZE(NrRlcDlStats_v3, Fmt),
           b, offset, length, result);
       int num_rb = _search_result_int(result, "Num RB");
       ...
       for (int i = 0; i < num_rb; i++) {
           PyObject* result_NrRlcDlStats_RBStats_item = PyList_New(0);
           offset += _decode_by_fmt(NrRlcDlStats_RBStats_v3,
               ARRAY_SIZE(NrRlcDlStats_RBStats_v3, Fmt),
               b, offset, length, result_NrRlcDlStats_RBStats_item);
           PyObject* t2 = Py_BuildValue("(sOs)", "Ignored",
                           result_NrRlcDlStats_RBStats_item, "dict");
           PyList_Append(result_NrRlcDlStats_RBStats, t2);

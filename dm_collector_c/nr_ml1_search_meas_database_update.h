...
const Fmt NrMl1SearchMeasDatabaseUpdateCont_Fmt_v2_9[] = {
    {UINT, "UNKNOWN", 4},
    {UINT, "Num Layers", 1},
    {UINT, "SSB Periodicity Serv Cell", 1},
    {SKIP, NULL, 2},
...
static void _convert_nr_rsrp_rsrq_v2_7(PyObject* obj, const char* rsrp_field) {
...
static void _judge_na_v2_7(PyObject* obj, const char* field, int standard) {
...
static int _decode_nr_ml1_search_meas_subpkt(const char* b, int offset,
    ...
    if ((major_ver == 2) && (minor_ver == 9)) {
        offset += _decode_by_fmt(
            NrMl1SearchMeasDatabaseUpdateCont_Fmt_v2_9,
            ARRAY_SIZE(NrMl1SearchMeasDatabaseUpdateCont_Fmt_v2_9, Fmt),  //
            b, offset, length, result);
    } else {
        offset += _decode_by_fmt(
            NrMl1SearchMeasDatabaseUpdateCont_Fmt,
            ...
            switch (minor_ver) {
                case 6: {
                    ...
                    for (int i = 0; i < n_layer; i++) {
                        ...
                        offset += _decode_by_fmt(
                            NrMl1SearchMeasCarrierList_v2_6,
                            ARRAY_SIZE(NrMl1SearchMeasCarrierList_v2_6, Fmt), b,
                            offset, length, result_layer);

                        int n_cells =
                            _search_result_int(result_layer, "Num Cells");
                        PyObject* result_allcells = PyList_New(0);

                        for (int j = 0; j < n_cells; j++) {
                            PyObject* result_cell = PyList_New(0);
                            offset += _decode_by_fmt(
                                NrMl1SearchMeasCellList_v2_6,
                            ...
                            int n_beams =
                                _search_result_int(result_cell, "Num Beams");

                            for (int k = 0; k < n_beams; k++) {
                                PyObject* result_beam = PyList_New(0);
                                offset += _decode_by_fmt(
                                    NrMl1SearchMeasDetectedBeam_v2_6,
                                    ARRAY_SIZE(NrMl1SearchMeasDetectedBeam_v2_6,
                                               Fmt),
                                ...
                                _convert_nr_rsrp(
                                    result_beam,
                                    "NR2NR Filtered Tx Beam RSRP L3");
                                _convert_nr_rsrq(
                                    result_beam,
                                    "NR2NR Filtered Tx Beam RSRQ L3");

                                _convert_nr_rsrp(result_beam,
                                                 "L2 NR Filtered Tx Beam RSRP");
                                _convert_nr_rsrq(result_beam,
                                                 "L2 NR Filtered Tx Beam RSRQ");

                                char name_beam[64];
                                sprintf(name_beam, "Beams[%d]", k);
                                PyObject* t_beam = Py_BuildValue(
                                    "(sOs)", name_beam, result_beam, "dict");
                            ...
                            PyObject* t_cell = Py_BuildValue(
                                "(sOs)", name_cell, result_cell, "dict");
                        ...
                        PyObject* t_allcells = Py_BuildValue(
                            "(sOs)", "Cells", result_allcells, "dict");
                    ...
                    t = Py_BuildValue("(sOs)", "Component_Carrier List",
                                      result_allcarriers, "list");
                ...
                case 7: {
                    ...
                    offset += _decode_by_fmt(
                        NrMl1SearchMeasFmtsubpkt_v2_7,
                        ARRAY_SIZE(NrMl1SearchMeasFmtsubpkt_v2_7, Fmt), b,
                    ...
                    for (int i = 0; i < n_layer; i++) {
                        PyObject* result_layer = PyList_New(0);
                        offset += _decode_by_fmt(
                            NrMl1SearchMeasCarrierList_v2_7,
                            ARRAY_SIZE(NrMl1SearchMeasCarrierList_v2_7, Fmt), b,
                            offset, length, result_layer);

                        int n_cells =
                            _search_result_int(result_layer, "Num Cells");
                        PyObject* result_allcells = PyList_New(0);
                        _convert_nr_rsrp_rsrq_v2_7(result_layer,
                                                   "ServingRsrpRx23[0]");
                        _convert_nr_rsrp_rsrq_v2_7(result_layer,
                                                   "ServingRsrpRx23[1]");

                        _judge_na_v2_7(result_layer, "Serving SSB", 0xff);
                        _judge_na_v2_7(result_layer, "Serving RX Beam[0]",
                                       0xffff);
                        _judge_na_v2_7(result_layer, "Serving RX Beam[1]",
                                       0xffff);
                        _judge_na_v2_7(result_layer, "Serving RFIC ID", 0xffff);
                        _judge_na_v2_7(result_layer, "ServingSubarrayId[0]",
                                       0xffff);
                        _judge_na_v2_7(result_layer, "ServingSubarrayId[1]",
                                       0xffff);
                        for (int j = 0; j < n_cells; j++) {
                            PyObject* result_cell = PyList_New(0);
                            offset += _decode_by_fmt(
                                NrMl1SearchMeasCellList_v2_7,
                                ARRAY_SIZE(NrMl1SearchMeasCellList_v2_7, Fmt),
                                b, offset, length, result_cell);
                            _convert_nr_rsrp_rsrq_v2_7(result_cell,
                                                       "Cell Quality Rsrp");
                            _convert_nr_rsrp_rsrq_v2_7(result_cell,
                                                       "Cell Quality Rsrq");
                            int n_beams =
                            ...
                            for (int k = 0; k < n_beams; k++) {
                                PyObject* result_beam = PyList_New(0);
                                offset += _decode_by_fmt(
                                    NrMl1SearchMeasDetectedBeam_v2_7,
                                    ARRAY_SIZE(NrMl1SearchMeasDetectedBeam_v2_7,
                                               Fmt),
                                    b, offset, length, result_beam);
                                _judge_na_v2_7(result_beam, "Rx Beam Id[0]",
                                               0x0000);
                                _judge_na_v2_7(result_beam, "Rx Beam Id[1]",
                                               0x0000);
                                _convert_nr_rsrp_rsrq_v2_7(
                                    result_beam, "RX Beam Info-RSRPs[0]");
                                _convert_nr_rsrp_rsrq_v2_7(
                                    result_beam, "RX Beam Info-RSRPs[1]");
                                _convert_nr_rsrp_rsrq_v2_7(
                                    result_beam, "Nr2NrFilteredBeamRsrpL3");
                                _convert_nr_rsrp_rsrq_v2_7(
                                    result_beam, "Nr2NrFilteredBeamRsrqL3");
                                _convert_nr_rsrp_rsrq_v2_7(
                                    result_beam, "L2NrFilteredTxBeamRsrpL3");
                                _convert_nr_rsrp_rsrq_v2_7(
                                    result_beam, "L2NrFilteredTxBeamRsrqL3");
                                char name_beam[64];
                                sprintf(name_beam, "Beams[%d]", k);
                                PyObject* t_beam = Py_BuildValue(
                                    "(sOs)", name_beam, result_beam, "dict");
                        ...
                        PyObject* t_allcells = Py_BuildValue(
                            "(sOs)", "Cells", result_allcells, "list");
                ...
                case 9: {
                    ...
                    _judge_na_v2_7(result, "SSB Periodicity Serv Cell", 0x00);
                    offset += _decode_by_fmt(
                        NrMl1SearchMeasFmtsubpkt_v2_9,
                        ARRAY_SIZE(NrMl1SearchMeasFmtsubpkt_v2_9, Fmt), b,
                        offset, length, result);
                    int temp = _search_result_int(result, "Frequency Offset");
                    float t_offset = temp * 0.0009766;
                    char f_offset[64];
                    ...
                    for (int i = 0; i < n_layer; i++) {
                        PyObject* result_layer = PyList_New(0);
                        offset += _decode_by_fmt(
                            NrMl1SearchMeasCarrierList_v2_9,
                            ARRAY_SIZE(NrMl1SearchMeasCarrierList_v2_9, Fmt), b,
                            offset, length, result_layer);
                        ...
                        for (int j = 0; j < n_cells; j++) {
                            PyObject* result_cell = PyList_New(0);
                            offset += _decode_by_fmt(
                                NrMl1SearchMeasCellList_v2_9,
                                ARRAY_SIZE(NrMl1SearchMeasCellList_v2_9, Fmt),
                                b, offset, length, result_cell);
                            _convert_nr_rsrp_rsrq_v2_7(result_cell,
                                                       "Cell Quality Rsrp");
                            _convert_nr_rsrp_rsrq_v2_7(result_cell,
                            ...
                            for (int k = 0; k < n_beams; k++) {
                                PyObject* result_beam = PyList_New(0);
                                offset += _decode_by_fmt(
                                    NrMl1SearchMeasDetectedBeam_v2_9,
                                    ARRAY_SIZE(NrMl1SearchMeasDetectedBeam_v2_9,
                                               Fmt),
                                    b, offset, length, result_beam);
                                _judge_na_v2_7(result_beam, "Rx Beam Id[0]",
                                               0x0000);
